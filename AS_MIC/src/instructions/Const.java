...
/**
 *
 * - Classe Const - A classe Const é responsável por decodicar e realizar as
 ...
 * contém 4 campos, sendo eles: - op(op-code) que indica ao processador qual
 * operação ele irá executar e possui tamanho de 8bits; - dest que indica o
 * registrador responsável por armazenar o resultado da operação e possui
 * tamanho de 5bits; - var que indica o registrador em 5bits; - cte que armazena
 * a constante em 14bits.
 *
 */
public class Const {
    ...
    /**
     * Método responsável por realizar a operação somai. Este método chama os
     * métodos load e store da Classe Registers.
     */
    public void somai() {
    ...
    /**
     * Método responsável por realizar a operação multi. Este método chama os
     * métodos load e store da Classe Registers.
     */
    public void multi() {
        String temp0 = "01000";
    ...
    public void store() {
        ...
        registerBank.store(dest, immediateValue3);
    }
}
